...
export function flattenChannel(channel: Channel): FlattenedNewsChannel | FlattenedTextChannel | FlattenedVoiceChannel | FlattenedGuildChannel | FlattenedDMChannel | FlattenedChannel {
