...
export default class extends Command {
	...
	private async list(message: KlasaMessage): Promise<KlasaMessage> {
	...
	private async delete(message: KlasaMessage, id: string): Promise<KlasaMessage> {
	...
	private async parseInput(message: KlasaMessage, input: string): Promise<{ time: number | null; title: string | null }> {
